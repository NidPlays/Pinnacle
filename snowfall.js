(() => {
  var n = {
      576: (n, t, r) => {
        ...
        (n = r.nmd(n)),
          (function () {
            var u =
                ("object" == ("undefined" == typeof self ? "undefined" : i(self)) && self.self === self && self) ||
                ("object" == (void 0 === r.g ? "undefined" : i(r.g)) && r.g.global === r.g && r.g) ||
                this ||
                {},
              o = u._,
              a = Array.prototype,
            ...
            (m.each = m.forEach =
              function (n, t, r) {
                var e, i;
                if (((t = w(t, r)), F(n))) for (e = 0, i = n.length; e < i; e++) t(n[e], e, n);
                else {
                  var u = m.keys(n);
            ...
            (m.reduce = m.foldl = m.inject = I(1)),
              ...
              (m.invoke = x(function (n, t, r) {
                var e, i;
                return (
                  m.isFunction(t) ? (i = t) : m.isArray(t) && ((e = t.slice(0, -1)), (t = t[t.length - 1])),
                  m.map(n, function (n) {
                    var u = i;
                    if (!u) {
            ...
            var R = function (n) {
              return function (t, r, e) {
                r = j(r, e);
                for (var i = E(t), u = n > 0 ? 0 : i - 1; u >= 0 && u < i; u += n) if (r(t[u], u, t)) return u;
                return -1;
              };
            };
            (m.findIndex = R(1)),
                ...
                var c = function () {
                  ...
                  f = function () {
                    ...
                    return (
                      (i = this),
                      (u = arguments),
                      l <= 0 || l > t ? (e && (clearTimeout(e), (e = null)), (a = f), (o = n.apply(i, u)), e || (i = u = null)) : e || !1 === r.trailing || (e = setTimeout(c, l)),
                      o
                    );
                  };
                return (
            ...
            (m.extend = W(m.allKeys)),
              ...
              (m.findKey = function (n, t, r) {
                t = j(t, r);
                for (var e, i = m.keys(n), u = 0, o = i.length; u < o; u++) if (t(n[(e = i[u])], e, n)) return e;
              });
            var H,
              K,
              C = function (n, t, r) {
            ...
            (m.pick = x(function (n, t) {
              ...
              (K = function (n, t, r, e) {
                ...
                e = e || [];
                for (var l = (r = r || []).length; l--; ) if (r[l] === n) return e[l] === t;
                if ((r.push(n), e.push(t), o)) {
                  ...
                  for (; l--; ) if (((s = h[l]), !_(t, s) || !H(n[s], t[s], r, e))) return !1;
                }
            ...
            (m.template = function (n, t, r) {
              ...
              var e,
                i = RegExp([(t.escape || G).source, (t.interpolate || G).source, (t.evaluate || G).source].join("|") + "|$", "g"),
                u = 0,
                o = "__p+='";
  ...
  (r.g = (function () {
    ...
    (() => {
      ...
      var o = r(576),
        a = { color: "orange", radius: [0.6, 5], speed: [1, 3], wind: [-1.5, 4] },
        c = function (t) {
