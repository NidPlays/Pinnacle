    ...
    t = {
      ...
      80: (e, t, r) => {
        ...
        function c(e) {
          if (
            s(e) &&
            ((t = e), (r = location.hostname.split(".").reverse()), (n = r[1] + "." + r[0]), (document.cookie = t + "=; domain=" + n + "; Path=/; Expires=Thu, 01 Jan 1970 00:00:01 GMT;"), !s(e))
          ) {
            try {
              location.reload(!0);
            } catch (e) {}
            ...
            (i.withCredentials = !0),
              (i.onreadystatechange = function () {
                if (4 === i.readyState && 200 === i.status) {
                  document.getElementById("btn-text").classList.toggle("op-0"), document.getElementById("btn-loader").classList.toggle("op-0");
                  var e = document.getElementById("subsc-email").value;
                  (document.getElementById("thank_you_msg").innerHTML = "You’re subscribed as " + e), (document.getElementById("subsc-email").value = "");
                  for (var t = document.getElementsByClassName("hide-after-success"), r = 0; r < t.length; r++) t[r].style.display = "none";
                  (f = !0),
                    document.getElementsByClassName("show-after-success")[0].classList.remove("hidden"),
                    setTimeout(function () {
                      document.getElementsByClassName("thank-you-title")[0].classList.toggle("hidden"),
                ...
                } else "" != i.responseText && JSON.parse(i.responseText).errors && p(JSON.parse(i.responseText).errors.email[0]), (f = !1);
              }),
              i.open("post", "".concat(u, "/api/pages/").concat(r, "/campaign/").concat(n, "/subscriber")),
        ...
        function y() {
          document.getElementById("subscribers-email-wrap").classList.remove("error-wrap"), (document.getElementById("subsc-email-error").innerText = "");
        }
        window.onload = function () {
          !(function () {
            ...
            (function () {
              for (var e = document.getElementsByClassName("show-embed"), t = 0; t < e.length; t++) e[t].addEventListener("click", i);
            })(),
            (function () {
              try {
                new URLSearchParams(window.location.search).get("preview") ? c("page_has_updated_preview") : c("page_has_updated");
              } catch (e) {}
            })();
          var e,
          ...
          null == h &&
            ...
            ("creator-page" == t &&
              (document.getElementById("toggle-subscription-btn").addEventListener("click", function (e) {
                document.getElementById("featured-subscribers").classList.toggle("hide-subscribers"),
                  f && document.getElementsByClassName("thank-you-title")[0].classList.toggle("hidden"),
                  (document.getElementById("featured-subscribers").style.cursor = "default");
              }),
              "true" === l &&
                document.querySelector("#featured-subscribers") &&
                document.querySelector("#featured-subscribers").addEventListener("click", function (e) {
                  document.getElementById("featured-subscribers").classList.contains("hide-subscribers") && "toggle-subscription-btn" !== e.target.id && "sub-toggle" !== e.target.id
                    ? (document.getElementById("featured-subscribers").classList.toggle("hide-subscribers"),
                      f && document.getElementsByClassName("thank-you-title")[0].classList.toggle("hidden"),
                      (document.getElementById("featured-subscribers").style.cursor = "default"))
                    : document.getElementById("featured-subscribers").classList.contains("hide-subscribers") && (document.getElementById("featured-subscribers").style.cursor = "pointer");
                })),
      ...
      666: (e) => {
        var t = (function (e) {
          ...
          function I(e, r) {
            ...
            if (n === t) {
              if (((r.delegate = null), "throw" === r.method)) {
                if (e.iterator.return && ((r.method = "return"), (r.arg = t), I(e, r), "throw" === r.method)) return g;
          ...
          return (
            ...
            (e.mark = function (e) {
              return Object.setPrototypeOf ? Object.setPrototypeOf(e, v) : ((e.__proto__ = v), c(e, s, "GeneratorFunction")), (e.prototype = Object.create(L)), e;
            }),
            (e.awrap = function (e) {
              return { __await: e };
            }),
  ...
  (n.m = t),
    ...
    (() => {
      ...
      var t = (t, r) => {
          ...
          for (c && c(n), t && t(r); u < i.length; u++) (a = i[u]), n.o(e, a) && e[a] && e[a][0](), (e[i[u]] = 0);
          n.O();
        },
